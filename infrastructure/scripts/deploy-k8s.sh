...
show_access_info() {
    ...
    echo "   kubectl port-forward svc/grafana-lb 3000:80 -n $NAMESPACE"
    echo "   Then open: http://localhost:3000 (admin/admin)"
    echo ""
    echo "📈 Prometheus:"
    echo "   kubectl port-forward svc/prometheus-lb 9090:80 -n $NAMESPACE"
    echo "   Then open: http://localhost:9090"
    echo ""
    echo "🔍 Jaeger Tracing:"
    echo "   kubectl port-forward svc/jaeger-ui 16686:80 -n $NAMESPACE"
